...
class MainViewModel: NSObject, PresentDialog {
    ...
    override init() {
        ...
        // More elaborate example for merging of two signals for
        ...
        let mergedSignal = matchCountShouldEnableSignal.combineLatest(with: removeMaxShouldEnableSignal).map({ x in
